# 1. Crea una tupla con los valores (10, 20, 30, 40, 50) e imprime la tupla.

my_tuple = (10, 20, 30, 40, 50)
print(my_tuple)

# 2. Accede al segundo elemento de la tupla (100, 200, 300, 400, 500) y muestra el resultado.
...
# 10. Crea una tupla con un solo elemento (el número 100) e imprime la tupla. Asegúrate de usar la sintaxis correcta para crear una tupla con un solo elemento.
