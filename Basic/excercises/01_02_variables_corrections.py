...
# 3. Declara una variable booleana is_student que indique si eres estudiante o no. Usa True o False según corresponda e imprímelala.
...
name, surname, city = "Alvaro", "Tester", "Galicia"
...
address = "Calle Morrones, 52, 46001, Valencia"
