# 1. Crea un set con los números del 1 al 5 e imprime el set.

my_set = {1, 2, 3, 4, 5}
print(my_set)

# 2. Añade el número 6 al set {1, 2, 3, 4, 5} e imprime el set.
...
my_set = {1, 2, 3}
del my_set
# print(my_set)  # Esto generará un error: NameError