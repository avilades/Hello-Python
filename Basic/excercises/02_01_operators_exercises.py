...
# 2. Calcula el resto de la división de 37 entre 5 y almacena en una variable remainder. Luego imprime.

# 3. Convierte el número 7 en una cadena de texto y concatena con la frase " es mi número favorito". Imprime el resultado.

# 4. Repite la palabra "Python" 10 veces usando el operador de multiplicación para cadenas y luego imprime.
